...
This meal plan is based on the traditional foods of countries like Greece,
Italy, and Spain. Key components include: plenty of fresh vegetables and
fruits, whole grains, legumes, nuts, seeds, and healthy fats (especially
extra virgin olive oil). Fish is included twice, and red meat is excluded.
